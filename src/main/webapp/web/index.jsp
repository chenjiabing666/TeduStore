    ...
    <div class="lf1_bottom">
        <div class="item_cat lf">
            ...
            <div class="item_cat_all">
            	<c:forEach var="computer" items="${computerList }" varStatus="s">
            		<p>${computer.name }</p>
            		<ul>
	            		<c:forEach var="list" items="${category161List }" begin="${s.index }" end="${s.index }">
	            			<c:forEach var="ls" items="${list }">
	            				<li><a href="${pageContext.request.contextPath }/goods/showSearch.do?categoryId=${ls.id}&categoryName=${ls.name}">${ls.name }</a></li>
	            			</c:forEach>
	            		</c:forEach>
            		</ul>
            	</c:forEach>
        ...
        <c:forEach var="good" items="${goods }">
        	<div class="item_msg lf">
	            <img src="..${good.image }" alt="" style="width: 198px;height: 136px;"/>
	
	            <p class="bottom_ys2" style="width: 198px;height: 28px;">${good.title }</p>
