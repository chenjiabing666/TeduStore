...
<div class="parent">
  ...
  <div class="container">
    <div class="panel rt">
      <form id="form-register" method="post" action="<%=request.getContextPath()%>/user/regist.do">
        <div class="txt">
          <p>新用户注册
            <span>
              <a href="<%=request.getContextPath()%>/user/showLogin.do">直接登录</a>
            </span>
          </p>
        </div>
   	 ...
   	 $.ajax({
   		 ...
   		 success:function(obj){
   			...
   			$("#unamespan").attr("class","msg-error");
   			 	...
   			 	//注册成功跳转到登录界面
   			 	// showLogin.do
   			 	location.href="<%=request.getContextPath()%>/user/showLogin.do";
   			}
   		 }
   	 });
    }
