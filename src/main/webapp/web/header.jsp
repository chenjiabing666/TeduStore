...
<header id="top" class="fixed_nav">
    ...
    <div class="rt">	
        <ul class="lf">
        	<li><a href="<%=request.getContextPath()%>/user/showPersonInfo.do">${sessionScope.user.username }</a></li>
            ...
            <c:if test="${sessionScope.user==null }"><li><a href="<%=request.getContextPath()%>/user/showLogin.do">登录</a></li></c:if>
            <c:if test="${sessionScope.user!=null }"><li><a href="<%=request.getContextPath()%>/user/exit.do">退出</a></li></c:if>
...
<nav id="nav">
    <ul>
        <li><a href="<%=request.getContextPath() %>/main/showIndex.do" class="acti">首页</a></li>
